...
tinymce.init({
    selector: ".editor",theme: "modern",skin:"light",width: 910,height: 300,
    plugins: [
  ...
  external_filemanager_path:"tinymce/tinymce/filemanager/",
   filemanager_title:"Responsive Filemanager" ,
  external_plugins: { "filemanager" : "filemanager/plugin.min.js"},
 });
 tinymce.init({
    selector: ".areasmall",theme: "modern",skin:"light",width: $(".areasmall").width(),height: 150,
    plugins: [
         "advlist autolink link image lists charmap print preview hr anchor pagebreak",
         "searchreplace wordcount visualblocks visualchars insertdatetime code media nonbreaking",
