...
<form name="frm" method="post" action="index.php?com=<?=$_GET['com']?>&act=save<?=$request?>" enctype="multipart/form-data" class="form-horizontal" >	 
...
<div class="panel panel-info">
 ...
 <div style="margin:0px 0" class="col-sm-12">
	<div class="form-group form-group-sm">
		<label for="" class="col-sm-4 control-label">Thương hiệu:</label>
		<div class="col-sm-8">
			<select required="" id="id_brand" class="form-control col-sm-8 " name="id_brand">
 ...
 <div class="col-xs-6">
	<div class="row">
		...
		<div class="col-sm-offset-4 col-sm-10">
		  <div class="checkbox">
			<label>
			  <input type="checkbox" name="is_request" <?=(@$item['is_request']==1)?'checked="checked"':''?> />Sản phẩm đổi trả
			</label>
		  </div>
		</div>
		<div class="col-sm-offset-4 col-sm-10">
		...
		<div class="col-sm-offset-4 col-sm-10">
		  <div class="checkbox">
			<label>
			  <input type="checkbox" name="new" <?=(@$item['new']==1)?'checked="checked"':''?> />Sản phẩm mới
			</label>
		  </div>
		</div>
		<?php } ?>
	...
	<ul class="nav nav-tabs">
		...
		<li class=""><a href="#size" data-toggle="tab"><strong>Kích thước</strong></a></li>
	...
	<div class="tab-content">
		...
		<?php
			...
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 control-label">Thông số kỹ thuật</label>
				
				
				<div class="col-sm-10">
				  <textarea  name="thongso_<?=$v?>" class="form-control editor" id="thongso_<?=$v?>" ><?=@$item['thongso_'.$v]?></textarea>
				</div>
			</div>
			<div class="clearfix"></div>
			
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 control-label">Chi tiết sản phẩm</label>
