  ...
  <div class="row">
	...
	<?=$admin->getListCategory(@$item,1) ?>
		<div class="form-group"><label for="" class="col-xs-4 control-label">Hình ảnh:</label> <div class="col-sm-8">
		 ...
		 <p></p>
				<p>
				<a class="fancybox"  href="<?=_upload_sanpham.@$item['photo']?>"><img  id="main-image" class="img-thumbnail" onerror="this.src='assets/img/no_photo.png'" src="<?=_upload_sanpham.@$item['photo']?>" class="col-xs-10" /></a>
				</p>
				<?php } ?>
		</div></div>
