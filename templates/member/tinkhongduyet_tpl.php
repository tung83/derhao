...
<div class="main-member-place">
	<div class="title"><h2>TIN KHÔNG DƯỢC DUYỆT</h2></div>
	<div class="content">
		<?php
			
		if(count($posts) > 0){
			echo '<table class="table table-bordered" >';
			echo '<thead><th>STT</th><th>Tiêu đề tin</th><th width=15%>Ngày đăng</th><th width=17%>Ngày cập nhật</th><th width=10%>Công cụ</th></thead>';
