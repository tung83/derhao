	...
	<div class="content lsd2" id="top-sld">	
		...
		<?php 
			...
			foreach($tintuc as $k=>$v){
				echo '<div class="col-xs-12 col-md-4 col-sm-6 col-lg-4">';
				echo '<div class="owl-item-inner">';
				
					echo '<div class="service-item"><div class="wrap">';
						echo '<a href="'.$com.'/'.$v['id'].'_'.$v['tenkhongdau'].'.html" title="'.$v['ten_'.$lang].'">
						...
						echo '<div class="desc"><div class="inner rel">';
							echo '<h2><a href="'.$com.'/'.$v['id'].'_'.$v['tenkhongdau'].'.html" title="'.$v['ten_'.$lang].'">'.$v['ten_'.$lang].'</a></h2>';
